...
const PUBLIC_TIMELINE_FIELDS = Object.freeze({
  ...
  coverage_plan_created: ["planSha256", "targetCheckpointIds", "reusedCheckpointIds", "pendingCheckpointIds", "routeIds", "totalEstimatedSeconds", "replanOf", "coveragePlan"],
  coverage_route_started: ["gameIndex", "routeId", "checkpointIds", "setupProfileId", "startStateId", "estimatedSeconds"],
  coverage_route_completed: ["gameIndex", "routeId", "checkpointIds", "setupProfileId", "endStateId", "durationMs", "evidenceRefs"],
  coverage_replanned: ["gameIndex", "previousPlanSha256", "newPlanSha256", "remainingCheckpointIds", "reason"],
