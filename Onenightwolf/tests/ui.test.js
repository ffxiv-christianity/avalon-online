...
assert(script.includes("討論時間結束後直接結算"));
assert(script.includes("未投票視為廢票"));
assert(script.includes("化身幽靈複製預言家、強盜、搗蛋鬼或酒鬼"));
assert(script.includes("該玩家的最終角色是化身幽靈最初複製的角色"));
assert(script.includes("多名獵人需要反擊時依 d100 座位順序行動"));
